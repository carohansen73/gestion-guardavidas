{{-- Lista para Mobile --}}
    <div class="space-y-4 sm:hidden">
        ...
        @can('agregar_intervencion')
            <a href="{{ route('intervencion.create') }}" class="btn fixed z-40 flex align-content-center bg-sky-500 dark:bg-sky-500 bottom-24 right-8 rounded-full px-3 py-3 shadow">
