        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
            @foreach ($intervenciones as $intervencion)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800"
                    ...
                    <td class="px-4 py-2">
                        <a href="{{ route('intervencion.show', $intervencion) }}" class="text-sky-600 hover:text-sky-400 dark:text-sky-400 hover:dark:text-sky-300">
                    ...
                    <td class="px-4 py-2">
                        <div class="flex space-x-2">
                            @can('editar_intervencion')
                                <a href="{{ route('intervencion.edit', $intervencion) }}" class="text-yellow-600 hover:underline">
