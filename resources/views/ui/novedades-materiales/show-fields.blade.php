...
<section class="text-gray-600 dark:text-gray-100 body-font px-4 py-10  ">
    ...
    <div class="flex justify-between align-center mb-sm-2">
         <h2 class="text-gray-700 text-2xl font-bold tracking-tight text-heading md:text-3xl lg:text-4xl">Detalles de la novedad</h2>
        <a href="{{ route('novedad-de-material.edit', $novedadDeMaterial) }}" class="btn hidden sm:flex align-center bg-sky-500 dark:bg-sky-700 hover:bg-sky-400 dark:hover:bg-sky-600 rounded-full px-3 py-2 shadow-md hover:shadow-xl">
