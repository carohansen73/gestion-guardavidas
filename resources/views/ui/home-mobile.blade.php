...
@section('content')
            ...
            @if (auth()->user()->can('ver_guardavida') ||
                ...
                <a class="bg-sky-600 dark:bg-sky-700 rounded flex px-4 py-3 h-full justify-between">
                    ...
                    <div class=" flex justify-end">
                        <button class="" type="button" data-drawer-target="drawer-bottom-example"
                            data-drawer-show="drawer-bottom-example" data-drawer-placement="bottom"
                            aria-controls="drawer-bottom-example">
                            <!-- icono tres puntos -->
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-three-dots-vertical text-gray-100 w-6 h-6" viewBox="0 0 16 16">
                                <path
    ...
    <div id="drawer-bottom-example"
        class="fixed bottom-0 left-0 right-0 z-50 w-full p-4 overflow-y-auto transition-transform translate-y-full bg-white dark:bg-gray-800 shadow-md"
        tabindex="-1" aria-labelledby="drawer-bottom-label">
        <h5 id="drawer-bottom-label"
            class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400">
            <svg class="w-4 h-4 me-2.5 text-orange-600 dark:text-orange-400" aria-hidden="true"
        ...
        <div class="py-4">
            <ul class="space-y-3 font-medium dark:text-gray-100">
                @can('ver_guardavida')
                    <li class="py-2">
                        <a href="{{ route('guardavida.index') }}" class=" inline-flex  font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148.42 68.38" class="w-5 h-5 me-2">
                                <path
                ...
                @can('ver_novedad_material')
                    <li class="py-2">
                        <a href="{{ route('novedad-de-material.index') }}" class=" inline-flex  font-medium  " disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 me-2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @can('ver_asistencia')
                    <li class="py-2">
                        <a href="{{ route('asistencias.index') }}" class=" inline-flex  font-medium  " disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 me-2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @can('ver_licencia')
                    <li class="py-2">
                        <a href="{{ route('licencia.index') }}" class="inline-flex font-medium" disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 me-2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @can('ver_cambio_turno')
                    <li class="py-2">
                        <a href="{{ route('cambio-de-turno.index') }}" class="inline-flex font-medium" disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-5 h-5 me-2">
                                <path stroke-linecap="round" stroke-linejoin="round"
