            ...
            <div class="container bg-white dark:bg-gray-600 w-full px-3 py-3 rounded">
                ...
                <div class="flex flex-column items-center justify-center text-center py-4 px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148.42 68.38"
                        class="text-sky-600 h-15 h-14  mb-3 inline-block">
                        <path
                ...
                <div class="border border-gray-200 dark:border-gray-400 rounded-xl shadow-md mb-2">
                    <ul>
                        @can('ver_guardavida')
                            <li
                                class="border-b border-gray-200 p-3 text-sky-600 dark:text-sky-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 rounded-t-xl">
                                <a href="{{ route('guardavida.index') }}" class="flex justify-content-between align-center ">
                                    <p>Guardavidas</h2>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="3" stroke="currentColor" class="w-6 h-6 py-1 px-1">
                        ...
                        @endcan
                        <li
                            class="border-b border-gray-200 p-3 text-sky-600 dark:text-sky-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900">
                            <a href="{{ route('asistencias.index') }}" class="flex justify-content-between align-center">
                                <p>Asistencia</h2>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="3" stroke="currentColor" class="w-6 h-6 py-1 px-1 ">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @can('ver_cambio_turno')
                            <li
                                class="p-3 text-sky-600 dark:text-sky-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 rounded-b-xl">
                                <a href="{{ route('cambio-de-turno.index') }}"
                                    class="flex justify-content-between align-center">
