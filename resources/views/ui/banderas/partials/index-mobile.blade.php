<div class="space-y-4 sm:hidden">
                        ...
                        <div class="px-4 py-2 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                            ...
                            <div class="flex justify-center py-3">
                                <div class="inline-flex rounded-md shadow-xs" role="group">
                                    ...
                                    @if(auth()->id() === $registro->user_id || auth()->user()->hasAnyRole(['encargado', 'admin']))
    ...
    @can('agregar_bandera')
        <a href="{{ route('bandera.create') }}" class="btn fixed z-40 flex align-content-center bg-sky-500 dark:bg-sky-500 bottom-24 right-8 rounded-full px-3 py-3 shadow">
