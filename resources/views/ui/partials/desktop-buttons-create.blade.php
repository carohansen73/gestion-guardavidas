            ...
            @can('agregar_intervencion')
                <div class="p-2 w-auto">
                    <a href="{{ route('intervencion.create') }}">
                        <div class="flex items-center px-2 py-3 rounded-lg shadow-md hover:shadow-xl cursor-pointer  bg-white dark:bg-gray-600 transition ease-in duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="mx-2 w-8 h-8 text-gray-400 py-1 px-1 rounded-xl">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                        </svg>
                    </div>
                    </a>
                ...
                <div class="p-2 w-auto">
                    <a href="{{ route('novedad-de-material.create') }}">
                        <div class="flex justify-center items-center px-2 py-3 rounded-lg shadow-md hover:shadow-xl cursor-pointer  bg-white dark:bg-gray-600 transition ease-in duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="text-amber-600 w-9 h-9 py-2 px-2 inline-block bg-amber-500/30 rounded-xl mx-2">
...
{{--
            ...
            <div class="p-2 w-auto">  <a href="{{ route('intervencion.create') }}">
                <div class="flex justify-center items-center px-2 py-3 rounded-lg shadow-md hover:shadow-xl cursor-pointer  bg-white dark:bg-gray-600 transition ease-in duration-300">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        class="text-teal-600 w-9 h-9 py-2 px-2 inline-block bg-teal-500/30 rounded-xl mx-2">
