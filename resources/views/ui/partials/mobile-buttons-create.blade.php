...
<section class="text-gray-600 body-font">
    <div class="container px-4 py-4 mx-auto">
        <div class="flex flex-col text-center w-full mb-2">
            <h1 class=" mb-2 text-gray-700 dark:text-white text-3xl font-bold tracking-tight text-heading md:text-4xl lg:text-5xl">Registrar un evento</h1>
        </div>
                    ...
                    <a href="{{ route('guardavida.create') }}">
                        <div class="px-4 py-6 rounded-lg shadow hover:shadow-md cursor-pointer bg-white dark:bg-gray-600 transition ease-in duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 148.42 68.38"
                             class="bg-sky-100 rounded-xl p-2 w-12 h-12 text-sky-600  dark:bg-sky-800 dark:text-sky-400 mx-auto mb-3 inline-block">
                                <path
                            ...
                            <p class="leading-none font-medium text-sky-800 dark:text-sky-300">Guardavida</p>
                        </div>
                    </a>
                </div>
            @endcan
            <div class="p-2 lg:w-1/3 md:w-1/3 sm:w-1/2 w-1/2 ">
                <a href="{{ route('activeCamera') }}">
                    <div class="px-4 py-6 rounded-lg shadow hover:shadow-md cursor-pointer bg-white transition ease-in duration-300">
                        ...
                        <p class="leading-none font-medium text-sky-800 dark:text-sky-300">Fichar</p>
                    </div>
                </a>
            </div>
                ...
                <div class="p-2 lg:w-1/3 md:w-1/3 sm:w-1/2 w-1/2 ">
                    <a href="{{ route('intervencion.create') }}">
                        <div class="px-4 py-8 rounded-lg shadow hover:shadow-md cursor-pointer bg-white dark:bg-gray-600 transition ease-in duration-300">
                            ...
                            <p class="leading-none font-medium text-sky-800 dark:text-sky-300">Intervención</p>
                        </div>
                    </a>
                </div>
            @endcan
            ...
            <div class="p-2 lg:w-1/3 md:w-1/3 sm:w-1/2 w-1/2 ">
                <a href="{{ route('novedad-de-material.create') }}">
                 <div class="px-4 py-6 rounded-lg shadow hover:shadow-md cursor-pointer bg-white dark:bg-gray-600 transition ease-in duration-300">
                    ...
                    <p class="leading-none font-medium text-sky-800 dark:text-sky-300">Novedad de Material</p>
                </div>
                </a>
            </div>
            @endcan
                ...
                <div class="p-2 lg:w-1/3 md:w-1/3 sm:w-1/2 w-1/2 ">
                    <a href="{{ route('cambio-de-turno.create') }}">
                        <div class="px-4 py-6 rounded-lg shadow hover:shadow-md cursor-pointer bg-white dark:bg-gray-600 transition ease-in duration-300">
                            ...
                            <p class="leading-none font-medium text-sky-800 dark:text-sky-300">Cambio de turno</p>
                        </div>
                    </a>
                </div>
            @endcan
            ...
            <div class="p-2 lg:w-1/3 md:w-1/3 sm:w-1/2 w-1/2 ">
                   <a href="{{ route('licencia.create') }}">
                        <div class="px-4 py-6 rounded-lg shadow hover:shadow-md cursor-pointer  bg-white dark:bg-gray-600 transition ease-in duration-300">
                            ...
                            <p class="leading-none font-medium text-sky-800 dark:text-sky-300">Licencia</p>
                        </div>
                   </a>
                </div>
            @endcan
