        ...
        <div class="p-2">
            ...
            >
               ...
               <div class="grid grid-cols-2 gap-2 mt-3 items-start auto-cols-max">
                       ...
                       <!-- Columna 1 - Bandera -->
                    <div class="flex flex-col items-center bg-gray-100/80 rounded-lg p-2 w-fit">
                        <div class="mb-1">
                    ...
                    <!-- Columna 2 - Tº y Viento -->
                     <div class="flex flex-col bg-gray-100/80 rounded-lg px-3 py-2 w-fit ml-auto items-end text-right text-gray-700 ">
                        <div class="flex mb-1 align-items-center">

                            <p class="text-sm font-medium">Temperatura: {{ $bandera->temperatura }}º</p>
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="size-5 text-amber-500 mx-1">
                        ...
                        <div class="flex mb-1 align-items-center">
                            ...
                            <p class="text-sm font-medium">Viento: {{ $bandera->viento_intensidad }} {{ $bandera->viento_direccion }}</p>
                             <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                stroke-width="1.5"
                                stroke="currentColor"
                                class="size-5 text-gray-800 mx-1">
                ...
                @can('agregar_bandera')
                    <a href="{{ route('bandera.create') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="w-8 h-8 py-2 px-2  bg-white p-1 text-dark rounded-full">
