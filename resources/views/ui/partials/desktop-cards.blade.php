        ...
        <div class="flex flex-wrap -m-4 text-center">
            ...
            <div class="p-2 md:w-1/3 sm:w-1/2 w-1/2 w-full">
                ...
                <div class="px-2 py-6 rounded-lg bg-white shadow-md hover:drop-shadow-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        class="bg-sky-600/20 text-sky-600  p-2 w-12 h-12 mb-3 inline-block rounded-xl" viewBox="0 0 24 24">
            ...
            <div class="p-2 md:w-1/3 sm:w-1/2 w-1/2 w-full">
                <a href="{{ route('intervencion.index') }}">
                    <div class="px-2 py-6 rounded-lg bg-white shadow-md hover:drop-shadow-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="bg-orange-600/20 text-orange-600 p-2 w-12 h-12 mb-3 inline-block rounded-xl">
            ...
            <div class="p-2 md:w-1/3 sm:w-1/2 w-full">
                <a href="{{ route('novedad-de-material.index') }}">
                    <div class="px-2 py-6 rounded-lg bg-white shadow-md hover:drop-shadow-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="bg-purple-500/30 text-purple-600 p-2 w-12 h-12 mb-3 inline-block rounded-xl">
