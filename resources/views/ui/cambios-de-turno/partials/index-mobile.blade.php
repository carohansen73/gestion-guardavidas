<div class="space-y-4 sm:hidden">
                        ...
                        <div class="px-4 py-2 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                            ...
                            <div class="flex justify-center py-3">
                                <div class="inline-flex rounded-md shadow-xs" role="group">
                                    ...
                                    <a  href="{{ route('cambio-de-turno.edit', $registro->id) }}"
                                    ...
                                    @can('eliminar_cambio_turno')
                                        <form action="{{ route('cambio-de-turno.destroy', $registro) }}" method="POST" onsubmit="return confirm('¿Seguro que deseas eliminar este cambio de turno?');">
                                            @csrf
                                            @method('DELETE')
    ...
    @can('agregar_cambio_turno')
        <a href="{{ route('cambio-de-turno.create') }}" class="btn fixed z-40 flex align-content-center bg-sky-500 dark:bg-sky-700 bottom-24 right-8 rounded-full px-3 py-3 shadow">
