    ...
    <div class="flex flex-col md:flex-row gap-6 px-6 py-6">
            ...
            <div class="grid grid-cols-12 gap-4 ">
                <div class="col-span-12 space-y-6 ">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                        ...
                        <div
                            class="rounded-2xl border border-gray-200 bg-white p-4 py-4 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                            <div class="flex justify-between">
                                <div>
                                    <div
                                        class="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="text-gray-600 p-2 inline-block">
                                ...
                                <div class="flex flex-col justify-end items-end text-end"
                                    id="porcentajeIntervencionesPorPlaya">
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between">
                                <div>
                                    <div
                                        class="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 dark:bg-teal-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="text-gray-600 p-2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <aside class="hidden md:block w-full md:w-1/3 ">
            ...
            <div class="mb-2 flex flex-wrap gap-2 items-center">
                <button class="btn-filtro bg-sky-100 text-blue-800 hover:bg-sky-200 px-2 py-1 rounded text-xs font-medium"
                    data-playa="" data-nombre="Todas">
                    Todas
                </button>
                ...
                @foreach ($playas as $playa)
                    <button
                        ...
                        data-playa="{{ $playa->id }}" data-nombre="{{ $playa->nombre }}">
                        {{ $playa->nombre }}
                    </button>
                @endforeach
            </div>
                    ...
                    @foreach ($novedades as $index => $novedad)
                        ...
                        <li class="mb-6 ms-6">
                            ...
                            <h3 class="flex items-center mb-1  font-semibold text-gray-900 dark:text-white">
                                ...
                                @if ($loop->first)
                                    <span
                                        class="bg-sky-100 text-sky-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">
                                        Latest
                                    </span>
                                @endif
                            </h3>
