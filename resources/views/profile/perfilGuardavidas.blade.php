                    ...
                    <div class="info-item">
                        ...
                        @if ($puedeEditar)
                            <div class="info-value editable">
                                ...
                                <input type="text" name="dni" class="form-control" value="{{ $guardavida->dni }}"
                                    required>
                            </div>
                        @else
                            <div class="info-value">
                        ...
                        @if ($puedeEditar)
                            <div class="info-value editable">
                                ...
                                <input type="email" name="email" class="form-control"
                                    value="{{ $guardavida->email ?? 'No especificado' }}">
                            </div>
                        @else
                            <div class="info-value">
                                <i class="fas fa-envelope"></i>
                                {{ $guardavida->email ?? 'No especificado' }}
                            </div>
                        @endif
                    </div>
                        ...
                        @if ($puedeEditar)
                            <div class="info-value editable">
                                ...
                                <input type="text" name="direccion" class="form-control"
                                    value="{{ $guardavida->ciudad ?? 'No especificado' }}">
                            </div>
                        @else
                            <div class="info-value">
                                <i class="fas fa-map-marker-alt"></i>
                                {{ $guardavida->ciudad ?? 'No especificado' }}
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        @if ($puedeEditar)
                            <div class="info-value editable">
                                <i class="fas fa-map-marker-alt"></i>
                                <input type="text" name="direccion" class="form-control"
                                    value="{{ $guardavida->calle ?? 'No especificado' }}">
                            </div>
                        @else
                            <div class="info-value">
                                <i class="fas fa-map-marker-alt"></i>
                                {{ $guardavida->calle ?? 'No especificado' }}
                            </div>
                        @endif
                    </div>
