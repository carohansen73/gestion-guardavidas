...
<head>
    ...
    <title>No se pudo procesar - {{ config('app.name', 'Gestión Guardavidas') }}</title>
...
<body class="font-sans antialiased">
    <div class="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-white dark:bg-gray-900 px-6">
        ...
        <div class="relative z-10 w-full sm:max-w-md text-center bg-white dark:bg-gray-800 shadow-md rounded-lg px-8 py-10">
            ...
            <p class="mt-6 text-sm font-semibold tracking-widest text-sky-600 uppercase">Error 405</p>

            <h1 class="mt-2 text-2xl font-semibold text-gray-800 dark:text-white">
                No pudimos procesar esa acción
            </h1>

            <p class="mt-3 text-sm text-gray-600 dark:text-gray-300">
                El sistema recibió un pedido que no esperaba para esta página. Volvé atrás e intentá de nuevo;
                si el problema sigue, avisale al administrador.
            </p>
