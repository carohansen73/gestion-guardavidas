{{--
    Botón + modal para exportar el Excel de "asistencia general" (elige un
    rango de fechas y dispara la descarga). Extraído de
    x-filtros-de-busqueda (que antes lo mezclaba con el filtro de playa y el
    buscador, rotos para esta vista porque filtraban solo del lado del
    cliente) para que las vistas de asistencias puedan usarlo solas, con su
    propio filtro real por GET.
--}}
<button type="button"
    onclick="openAsistenciaModal('asistencia-general')"
