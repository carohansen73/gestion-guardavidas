...
class CambioDeTurnoPolicy
{
     ...
     */
    public function restore(User $user, CambioDeTurno $cambioDeTurno): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, CambioDeTurno $cambioDeTurno): bool
    {
        return false;
    }
}
